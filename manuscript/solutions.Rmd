...
<!-- figure 2 -->
```{r, barplot, fig.align="center", out.width="75%", fig.cap = "Distribusi geografik. \\label{b_plot}"}
...
Placerat nisl pretium mus malesuada pellentesque \autoref{b_plot1}.

<!-- figure 2 -->
```{r, barplot1, fig.align="center", out.width="75%", fig.cap = "Distribusi geografik. \\label{b_plot1}"}
