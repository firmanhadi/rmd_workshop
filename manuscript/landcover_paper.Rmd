...
<!-- paragraph 9 -->
@delgado2010 12 'mus auctor' ipsum. Himenaeos metus in fames aliquam. Vel suspendisse purus congue sed sed ut et. Ultrices ut sem. Urna volutpat vivamus velit, consectetur molestie turpis in [@bennett2015; @delgado2010].
...
Vitae sapien eu pulvinar cursus ac. Sed sapien et a ipsum sed enim eget. Tempor eu mattis, fringilla id eros ut \autoref{markdown_table}.
...
\autoref{class_plot} lectus mauris, risus nisl fames vitae aptent ac sed. At et eleifend elit per aptent habitant? Arcu magnis rutrum gravida cubilia diam, ipsum senectus scelerisque rutrum. Elementum, mi arcu nunc sed congue neque ac elementum. Quis iaculis sed, ex odio velit. Parturient amet aliquam. Vehicula, curae, primis eros sed eu mauris. Massa neque eu vestibulum augue in fames vel? Tincidunt ac sollicitudin tempor turpis, tortor elit pharetra, sagittis. 

<!-- figure classification map -->
```{r, classification, fig.align="center", out.width="75%", fig.cap = "Classification result. \\label{class_plot}"}
...
#data_dir <- "/Volumes/Extreme SSD/Dropbox/Research/LandCover/Sragen/sits/sragen_1_7_21/images"
...
#6
library(readr)
#sampel3 <- read_csv("sampel3.csv")

#samples_S2_49MDM_MEM_2021_local <- sits_get_data(s2_local_cube, sampel3, multicores=5)
...
#6 bands
#8
#rf_model6 <- sits_train(samples_s2_6bands,
#  ml_method = sits_rfor()
#)
...
s2_probs6_rf <- sits_classify(
  ...
  memsize = 8,
  multicores = 6,
  output_dir  = "./images_6bands_rfor2/"
)
...
#RandomForest
#11
s2_bayes6_rf <- sits_smooth(s2_probs6_rf, type = "bayes", output_dir = "./images_6bands_rfor2/")
...
#6 bands
#13
#val_rfor6 <- sits_kfold_validate(samples_s2_6bands, 
 #                                   folds = 5, 
#                                    ml_method = sits_rfor())
